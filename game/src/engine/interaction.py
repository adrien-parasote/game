...
class InteractionManager(InteractionEmoteMixin):
    """
    ...
    def _check_pickup_interactions(self) -> bool:
        ...
        for pickup in self.game.pickups:
            ...
            if not (is_on_top or (is_aligned and facing_toward(p_pos, p_state, pickup.pos))):
                continue
    ...
    def check_teleporters(self, was_moving: bool):  # noqa: C901
        ...
        for tp in self.game.teleports_group:
            ...
            # Spec: game/docs/specs/intra-map-teleport.md § 4.1
