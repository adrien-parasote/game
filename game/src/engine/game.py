...
class Game:
    ...
    def _init_groups(self):
        ...
        # Spec: game/docs/specs/intra-map-teleport.md § 4.4.1
    ...
    def intra_map_teleport(self, target_spawn_id: str, transition_type: str) -> None:
        ...
        Spec: game/docs/specs/intra-map-teleport.md § 4.3
        """
    ...
    def _start_intra_walk(self, target: pygame.math.Vector2) -> None:
        ...
        Spec: game/docs/specs/intra-map-teleport.md § 4.4.2
        """
    ...
    def _tick_intra_walk(self, dt: float) -> None:
        ...
        Spec: game/docs/specs/intra-map-teleport.md § 4.4.3
        """
    ...
    def _update_core_state(self, dt: float):
        ...
        # Spec: game/docs/specs/intra-map-teleport.md § 4.5
