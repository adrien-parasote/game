...
SEASON_ICON_CENTER: tuple = (int(312.0 * HUD_SCALE), int(277.0 * HUD_SCALE))
TIME_ANCHOR: tuple = (int(269.5 * HUD_SCALE), int(96.0 * HUD_SCALE))
SEASON_DAY_ANCHOR: tuple = (int(137.0 * HUD_SCALE), int(281.5 * HUD_SCALE))
