...
SEASON_ICON_CENTER: tuple = (int(292.0 * HUD_SCALE), int(262.0 * HUD_SCALE))
TIME_ANCHOR: tuple = (int(290.0 * HUD_SCALE), int(118.0 * HUD_SCALE))
SEASON_DAY_ANCHOR: tuple = (int(103.5 * HUD_SCALE), int(246.0 * HUD_SCALE))
