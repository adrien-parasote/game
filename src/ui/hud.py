...
SEASON_ICON_CENTER: tuple = (int(310.0 * HUD_SCALE), int(275.0 * HUD_SCALE))
TIME_ANCHOR: tuple = (int(255.0 * HUD_SCALE), int(100.0 * HUD_SCALE))
SEASON_DAY_ANCHOR: tuple = (int(140.0 * HUD_SCALE), int(285.0 * HUD_SCALE))
