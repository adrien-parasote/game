...
SEASON_ICON_CENTER: tuple = (int(310.0 * HUD_SCALE), int(266.0 * HUD_SCALE))
TIME_ANCHOR: tuple = (int(282.4 * HUD_SCALE), int(98.2 * HUD_SCALE))
SEASON_DAY_ANCHOR: tuple = (int(110.6 * HUD_SCALE), int(281.9 * HUD_SCALE))
