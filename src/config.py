...
class Settings:
    ...
    _DEFAULTS = {
        ...
        "time": {"minute_duration": 1.0, "days_per_season": 30, "initial_season": 0},
        "npc": {"speed": 40, "animation_speed": 8.0},
        "ui": {"text_speed": 0.05, "cursor_size": 48, "enable_failed_interaction_emote": True},
        "audio": {"bgm_volume": 0.5, "sfx_volume": 0.5},
        "locale": "fr",
        "fonts": {
