...
def test_on_mode_change() -> None:
    with patch("asset_creator.gui.app.dpg.get_value", return_value="standalone"), \
...
def test_do_regenerate_autotile() -> None:
    app._state = app.state_from_preset("grass", app._presets)
    with patch("asset_creator.gui.app.dpg.get_value", return_value="autotile"), \
...
def test_history_select() -> None:
    ...
    with patch("asset_creator.gui.app.dpg.set_value"), \
        ...
        with patch("asset_creator.gui.app._sync_widgets_from_state"), \
