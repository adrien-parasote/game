...
Tests derived directly from scripts/game/docs/specs/autotile-pipeline-spec.md
...
from tools.src.autotiles.rpgmaker_autotile_to_tiled import (
    _Q,
    TILE_COUNT,
    TILE_SIZE,
    _quarter_source,
...
def test_ut001_no_args_exits_with_usage(monkeypatch):
    ...
    from tools.src.autotiles.rpgmaker_autotile_to_tiled import main
