...
from asset_creator.core.constants import (
    TUFT_CLASSIC_RIGHT, TUFT_CLASSIC_LEFT, TUFT_CLASSIC_V,
    TUFT_SHORT_1, TUFT_SHORT_2, TUFT_SHORT_3,
    TUFT_CURLY_1, TUFT_CURLY_2, TUFT_CURLY_3,
    TUFT_WILD_1, TUFT_WILD_2
)
