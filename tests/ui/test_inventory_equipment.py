...
class TestInventoryEquipment(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_i18n.return_value.get_item.return_value = {"name": "Test Potion", "description": "Desc"}
    ...
    def test_equipment_initialization(self):
        ...
        expected_slots = ["HEAD", "BAG", "BELT", "LEFT_HAND", "UPPER_BODY", "LOWER_BODY", "RIGHT_HAND", "SHOES"]
