...
from tools.asset_creator.gui.canvas import CanvasState
from tools.asset_creator.gui.pipeline import regenerate_tileset, tiles_to_strip
...
class TestIT004Export:
    ...
    def test_export_creates_png_and_tsx(self, presets: dict) -> None:
        from tools.asset_creator.gui.pipeline import do_export
