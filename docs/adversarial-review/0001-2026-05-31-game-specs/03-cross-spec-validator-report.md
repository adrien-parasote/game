...
| 9. File Tree Completeness | ❌ FAIL | 77 |
| 10. Concept Coherence | ✅ PASS | 0 |

**Total: 86 issues, 86 critical**
...
**Issue C2** — Possible typo: `BLEND_RGBA_MIN` used but `BLEND_RGBA_MULT` declared (similarity: 80%).
...
### ❌ 9. File Tree Completeness (77 issues)
...
**Issue F19** — Spec `development-quality.md` references path `settings.json` but no spec's file tree declares it.
- Used in: development-quality.md
...
**Issue F20** — Spec `development-quality.md` references path `../../tests/scripts/build/test_release.py` but no spec's file tree declares it.
- Used in: development-quality.md
...
**Issue F21** — Spec `dialogue-system.md` references path `../../tests/ui/test_dialogue.py` but no spec's file tree declares it.
...
**Issue F22** — Spec `dialogue-system.md` references path `../../tests/ui/test_speech_bubble.py` but no spec's file tree declares it.
- Used in: dialogue-system.md
...
**Issue F23** — Spec `dialogue-system.md` references path `../../tests/ui/test_inventory.py` but no spec's file tree declares it.
- Used in: dialogue-system.md
...
**Issue F24** — Spec `dialogue-system.md` references path `test_dialogue.py` but no spec's file tree declares it.
- Used in: dialogue-system.md
...
**Issue F25** — Spec `engine-core.md` references path `../../tests/engine/test_game.py` but no spec's file tree declares it.
...
**Issue F26** — Spec `engine-core.md` references path `../../tests/engine/test_game_state_manager.py` but no spec's file tree declares it.
- Used in: engine-core.md
...
**Issue F27** — Spec `engine-core.md` references path `../../tests/engine/test_collision_checker.py` but no spec's file tree declares it.
- Used in: engine-core.md
...
**Issue F28** — Spec `engine-core.md` references path `../../tests/engine/test_spatial_utils.py` but no spec's file tree declares it.
- Used in: engine-core.md
...
**Issue F29** — Spec `engine-core.md` references path `../../tests/engine/test_phase15_game.py` but no spec's file tree declares it.
- Used in: engine-core.md
...
**Issue F30** — Spec `engine-core.md` references path `../../tests/ui/test_title_screen.py` but no spec's file tree declares it.
- Used in: engine-core.md
...
**Issue F31** — Spec `entities-system.md` references path `propertytypes.json` but no spec's file tree declares it.
...
**Issue F32** — Spec `entities-system.md` references path `../../tests/entities/test_interactive.py` but no spec's file tree declares it.
- Used in: entities-system.md
...
**Issue F33** — Spec `entities-system.md` references path `../../tests/entities/test_sprite_frame_loading.py` but no spec's file tree declares it.
- Used in: entities-system.md
...
**Issue F34** — Spec `entities-system.md` references path `../../tests/entities/test_entities.py` but no spec's file tree declares it.
- Used in: entities-system.md
...
**Issue F35** — Spec `entities-system.md` references path `../../tests/engine/test_interaction.py` but no spec's file tree declares it.
- Used in: entities-system.md
...
**Issue F36** — Spec `intra-map-teleport.md` references path `interaction.py` but no spec's file tree declares it.
...
**Issue F37** — Spec `intra-map-teleport.md` references path `map_loader.py` but no spec's file tree declares it.
- Used in: intra-map-teleport.md
...
**Issue F38** — Spec `intra-map-teleport.md` references path `map-world-system.md` but no spec's file tree declares it.
- Used in: intra-map-teleport.md
...
**Issue F39** — Spec `intra-map-teleport.md` references path `../../tests/engine/test_intra_map_teleport.py` but no spec's file tree declares it.
- Used in: intra-map-teleport.md
...
**Issue F40** — Spec `intra-map-teleport.md` references path `../../tests/engine/test_render_order.py` but no spec's file tree declares it.
- Used in: intra-map-teleport.md
...
**Issue F41** — Spec `inventory-system.md` references path `propertytypes.json` but no spec's file tree declares it.
- Used in: inventory-system.md
- Suggested fix: Either: (a) add `propertytypes.json` to the file tree of the spec that owns this deliverable, or (b) mark `propertytypes.json` as an external dependency if it's not produced by this project.

**Issue F42** — Spec `inventory-system.md` references path `loot_table.json` but no spec's file tree declares it.
- Used in: inventory-system.md
...
**Issue F43** — Spec `inventory-system.md` references path `../../tests/ui/test_inventory.py` but no spec's file tree declares it.
- Used in: inventory-system.md
- Suggested fix: Either: (a) add `../../tests/ui/test_inventory.py` to the file tree of the spec that owns this deliverable, or (b) mark `../../tests/ui/test_inventory.py` as an external dependency if it's not produced by this project.

**Issue F44** — Spec `inventory-system.md` references path `../../tests/engine/test_loot_table.py` but no spec's file tree declares it.
- Used in: inventory-system.md
...
**Issue F45** — Spec `lighting-system.md` references path `../../tests/engine/test_lighting.py` but no spec's file tree declares it.
...
**Issue F46** — Spec `map-world-system.md` references path `../../tests/engine/test_interaction.py` but no spec's file tree declares it.
- Used in: map-world-system.md
- Suggested fix: Either: (a) add `../../tests/engine/test_interaction.py` to the file tree of the spec that owns this deliverable, or (b) mark `../../tests/engine/test_interaction.py` as an external dependency if it's not produced by this project.

**Issue F47** — Spec `map-world-system.md` references path `../../tests/engine/test_map_loader.py` but no spec's file tree declares it.
- Used in: map-world-system.md
...
**Issue F48** — Spec `map-world-system.md` references path `../../tests/engine/test_phase15_game.py` but no spec's file tree declares it.
- Used in: map-world-system.md
- Suggested fix: Either: (a) add `../../tests/engine/test_phase15_game.py` to the file tree of the spec that owns this deliverable, or (b) mark `../../tests/engine/test_phase15_game.py` as an external dependency if it's not produced by this project.

**Issue F49** — Spec `npc-system.md` references path `test_npc.py` but no spec's file tree declares it.
...
**Issue F50** — Spec `npc-system.md` references path `sprites/` but no spec's file tree declares it.
- Used in: npc-system.md
...
**Issue F51** — Spec `npc-system.md` references path `characters/` but no spec's file tree declares it.
- Used in: npc-system.md
...
**Issue F52** — Spec `npc-system.md` references path `../../tests/entities/test_entities.py` but no spec's file tree declares it.
- Used in: npc-system.md
- Suggested fix: Either: (a) add `../../tests/entities/test_entities.py` to the file tree of the spec that owns this deliverable, or (b) mark `../../tests/entities/test_entities.py` as an external dependency if it's not produced by this project.

**Issue F53** — Spec `npc-system.md` references path `../../tests/entities/test_npc.py` but no spec's file tree declares it.
- Used in: npc-system.md
...
**Issue F54** — Spec `npc-system.md` references path `../../tests/engine/test_interaction.py` but no spec's file tree declares it.
- Used in: npc-system.md
- Suggested fix: Either: (a) add `../../tests/engine/test_interaction.py` to the file tree of the spec that owns this deliverable, or (b) mark `../../tests/engine/test_interaction.py` as an external dependency if it's not produced by this project.

**Issue F55** — Spec `performance-system.md` references path `../../tests/engine/test_performance_optimizations.py` but no spec's file tree declares it.
...
**Issue F56** — Spec `pygame_ce_python_312_best_practices.md` references path `pyproject.toml` but no spec's file tree declares it.
...
**Issue F57** — Spec `remediation_01_dt_text_cache.md` references path `best_practices_remediation_blueprint.md` but no spec's file tree declares it.
...
**Issue F58** — Spec `remediation_01_dt_text_cache.md` references path `pygame_ce_python_312_best_practices.md` but no spec's file tree declares it.
- Used in: remediation_01_dt_text_cache.md
...
**Issue F59** — Spec `remediation_01_dt_text_cache.md` references path `../../tests/engine/test_dt_clamp.py` but no spec's file tree declares it.
- Used in: remediation_01_dt_text_cache.md
...
**Issue F60** — Spec `remediation_01_dt_text_cache.md` references path `../../tests/ui/test_text_cache.py` but no spec's file tree declares it.
- Used in: remediation_01_dt_text_cache.md
...
**Issue F61** — Spec `remediation_02_saves_assets_pyright.md` references path `best_practices_remediation_blueprint.md` but no spec's file tree declares it.
- Used in: remediation_02_saves_assets_pyright.md
- Suggested fix: Either: (a) add `best_practices_remediation_blueprint.md` to the file tree of the spec that owns this deliverable, or (b) mark `best_practices_remediation_blueprint.md` as an external dependency if it's not produced by this project.

**Issue F62** — Spec `remediation_02_saves_assets_pyright.md` references path `pygame_ce_python_312_best_practices.md` but no spec's file tree declares it.
- Used in: remediation_02_saves_assets_pyright.md
- Suggested fix: Either: (a) add `pygame_ce_python_312_best_practices.md` to the file tree of the spec that owns this deliverable, or (b) mark `pygame_ce_python_312_best_practices.md` as an external dependency if it's not produced by this project.

**Issue F63** — Spec `remediation_02_saves_assets_pyright.md` references path `asset_manager.py` but no spec's file tree declares it.
- Used in: remediation_02_saves_assets_pyright.md
...
**Issue F64** — Spec `remediation_02_saves_assets_pyright.md` references path `engine-core.md` but no spec's file tree declares it.
- Used in: remediation_02_saves_assets_pyright.md
...
**Issue F65** — Spec `remediation_02_saves_assets_pyright.md` references path `lighting.py` but no spec's file tree declares it.
- Used in: remediation_02_saves_assets_pyright.md
...
**Issue F66** — Spec `remediation_03_modernization.md` references path `best_practices_remediation_blueprint.md` but no spec's file tree declares it.
- Used in: remediation_03_modernization.md
- Suggested fix: Either: (a) add `best_practices_remediation_blueprint.md` to the file tree of the spec that owns this deliverable, or (b) mark `best_practices_remediation_blueprint.md` as an external dependency if it's not produced by this project.

**Issue F67** — Spec `remediation_03_modernization.md` references path `pygame_ce_python_312_best_practices.md` but no spec's file tree declares it.
- Used in: remediation_03_modernization.md
- Suggested fix: Either: (a) add `pygame_ce_python_312_best_practices.md` to the file tree of the spec that owns this deliverable, or (b) mark `pygame_ce_python_312_best_practices.md` as an external dependency if it's not produced by this project.

**Issue F68** — Spec `remediation_03_modernization.md` references path `collision_checker.py` but no spec's file tree declares it.
- Used in: remediation_03_modernization.md
...
**Issue F69** — Spec `remediation_03_modernization.md` references path `entities-system.md` but no spec's file tree declares it.
- Used in: remediation_03_modernization.md
...
**Issue F70** — Spec `remediation_03_modernization.md` references path `asset_manager.py` but no spec's file tree declares it.
- Used in: remediation_03_modernization.md
- Suggested fix: Either: (a) add `asset_manager.py` to the file tree of the spec that owns this deliverable, or (b) mark `asset_manager.py` as an external dependency if it's not produced by this project.

**Issue F71** — Spec `save-system.md` references path `saves/slot_1_thumb.png` but no spec's file tree declares it.
...
**Issue F72** — Spec `save-system.md` references path `saves/` but no spec's file tree declares it.
- Used in: save-system.md
...
**Issue F73** — Spec `save-system.md` references path `saves/slot_X` but no spec's file tree declares it.
- Used in: save-system.md
...
**Issue F74** — Spec `save-system.md` references path `../../tests/engine/test_save_manager.py` but no spec's file tree declares it.
- Used in: save-system.md
...
**Issue F75** — Spec `save-system.md` references path `../../tests/ui/test_title_screen.py` but no spec's file tree declares it.
- Used in: save-system.md
- Suggested fix: Either: (a) add `../../tests/ui/test_title_screen.py` to the file tree of the spec that owns this deliverable, or (b) mark `../../tests/ui/test_title_screen.py` as an external dependency if it's not produced by this project.

**Issue F76** — Spec `save-system.md` references path `../../tests/ui/test_save_menu.py` but no spec's file tree declares it.
- Used in: save-system.md
...
**Issue F77** — Spec `save-system.md` references path `../../tests/ui/test_pause_screen.py` but no spec's file tree declares it.
- Used in: save-system.md
...
C1 tracked: 0 concepts. C3 advisory: 5 concepts mentioned in ≥ 3 specs.
