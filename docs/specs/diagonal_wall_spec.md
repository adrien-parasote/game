...
> Strategic Blueprint: [`docs/strategic/diagonal_wall_blueprint.md`](../strategic/diagonal_wall_blueprint.md#blueprint-2d-diagonal-wall-tile-transformation-utility)  
> Date: 2026-05-28  
...
|---|---|---|---|
| CLI Command | `python3 scripts/autotiles/flat_wall_to_diagonal.py` | Run the batch diagonal transformation | Section 5.1 (CLI Reference) |
