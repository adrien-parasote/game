...
- NPC System with basic AI and interactions (Integration PENDING).
- Fixed Interactive Objects (chests, switches) with unified interaction and collision [COMPLETE].
