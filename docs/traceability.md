<!-- Auto-generated by scripts/dev/tc_report.py -->
...
| TC ID | Status | Test |
|-------|--------|------|
| TC-REL-01 | ✅ | `tests/scripts/build/test_release.py::test_validate_version` |
| TC-REL-02 | ✅ | `tests/scripts/build/test_release.py::test_update_version` |
| TC-REL-03 | ✅ | `tests/scripts/build/test_release.py::test_run_git_commands` |
