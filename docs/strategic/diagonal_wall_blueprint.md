...
> **Implementation Spec:** [`docs/specs/diagonal_wall_spec.md`](../specs/diagonal_wall_spec.md)  
> **Date:** 2026-05-28  
...
* The conversion script will be located at `scripts/autotiles/flat_wall_to_diagonal.py`.
