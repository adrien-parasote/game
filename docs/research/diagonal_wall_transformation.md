...
* **Chosen Approach:** **Build** (Create a dedicated Python script `scripts/autotiles/flat_wall_to_diagonal.py` to automate this vertical shear transformation for any flat tileset assets).
